...
{
    Task<Result<OrderView>> GetByIdAsync(Guid id, CancellationToken cancellationToken);
    Task<Page<OrderView>> GetPageAsync(QueryParams queryParams, CancellationToken cancellationToken);
